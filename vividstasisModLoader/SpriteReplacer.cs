            ...
            foreach (Atlas atlas in packer.Atlasses)
            {
                ...
                foreach (Node n in atlas.Nodes)
                {
                    if (n.Texture != null)
                    {
                        ...
                        var spriteType = GetSpriteType(n.Texture.Source);
                        if (importAsSprite)
                        {
                        ...
                        else if (spriteType == SpriteType.Sprite)
                        {
                            ...
                            if (sprite is null)
                            {
                                ...
                                if (!noMasksForBasicRectangles || newSprite.SepMasks is not (UndertaleSprite.SepMaskType.AxisAlignedRect or UndertaleSprite.SepMaskType.RotatedRect))
                                {
